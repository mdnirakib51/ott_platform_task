...
class SeriesSeeAllScreen extends StatefulWidget {
  const SeriesSeeAllScreen({super.key,});
  @override
  State<SeriesSeeAllScreen> createState() => _SeriesSeeAllScreenState();
}

class _SeriesSeeAllScreenState extends State<SeriesSeeAllScreen> {
